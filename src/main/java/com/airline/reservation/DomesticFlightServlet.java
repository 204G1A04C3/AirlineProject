...
public class DomesticFlightServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            DomesticFlightDAO dao = new DomesticFlightDAO();
            List<Flight> flights;
            if (sourceCity != null && destinationCity != null) {
                flights = dao.searchDomesticFlights(sourceCity, destinationCity);
            } else {
                flights = dao.getDomesticFlights();
            }
            ...
            out.println("<h1>Domestic Flights</h1>");

            // Search Form
            out.println("<form action='DomesticFlights' method='get'>");
            ...
            out.println("<form action='DomesticFlights' method='post'>");
            ...
            out.println("<input type='number' id='numPassengers' name='numPassengers' min='1' required><br>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String flightQuery = "SELECT source_city, destination_city, departure_time, arrival_time, economy_fare, business_fare, seats_available FROM domestic_flights WHERE flight_id = ?";
            ...
            if (flightResultSet.next()) {
                ...
                String updateSeatsQuery = "UPDATE domestic_flights SET seats_available = seats_available - ? WHERE flight_id = ?";
